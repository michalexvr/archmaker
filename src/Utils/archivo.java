...
public class archivo {
    ...
    public void creteDirectory(String ruta)
    {
    ...
    public boolean isDirectory(String ruta)
    {
        directorio = new File(ruta);
        
        return directorio.isDirectory();
    }
    public boolean searchDirectory(String direc)
    {
        String[] ls = directorio.list();
        int num = ls.length;
        int i=0;
        while(i<num)
        {
            if(ls[i].equals(direc))
            {
    ...
    public boolean searchArchivos(String archivo)
    {
        String[] data=null;
        int num=0;
        try
   ...
   public void cerrarEscritura(){
    ...
    private void crearArchivo(){
        try {
              ...
              arch.createNewFile();
              //arch = new arch("/home/xion/Gonzalo/Diciembre");
    ...
    public String[] LeerLineas(){
        ...
        try{
            ...
            return lineas;
              ...
              logFile.addReg("fallo en las lecturas de lineas"+ex);
          }
   ...
   public boolean escribirLinea( String cadena ){
       try{
           ...
           String ctemp = retLastContenido() + cadena;
           fw = new FileWriter ( arch );
           bw = new BufferedWriter ( fw );
           salArch = new PrintWriter( bw );
